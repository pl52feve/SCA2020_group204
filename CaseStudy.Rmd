...
rawdata$date = paste(rawdata$arrival_date_day_of_month, rawdata$arrival_date_month, rawdata$arrival_date_year)

Wochenendtab = data.frame(rawdata$date[1],FALSE)

while(date != "31 August 2017"){
  i = 3
  if(i==5 | i==6 |i==7){
    Wochenendtab
  }
